...
public class DomainsAdapter extends BaseExpandableListAdapter {
    ...
    public DomainsAdapter(Context context, List<String> listGroup, HashMap<String, List<String>> listItem) {
    ...
    public View getGroupView(int i, boolean b, View view, ViewGroup viewGroup) {
        ...
        if(view == null) {
            ...
            view = layoutInflater.inflate(R.layout.domain_list_group, null);
        }
    ...
    public View getChildView(int i, int i1, boolean b, View view, ViewGroup viewGroup) {
        ...
        if(view == null) {
            ...
            view = inflater.inflate(R.layout.subdomain_list_item, null);
        }
